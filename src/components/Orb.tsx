...
const haloGradients: Record<OrbState, string> = {
  ...
  listening: "radial-gradient(circle, hsla(0,0%,90%,0.35) 0%, transparent 70%)",
    ...
    <div className="relative flex items-center justify-center" style={{ width: 280, height: 280 }}>
      ...
      <div
        className={cn(
          ...
          orbState === "listening" && "bg-white/20",
      ...
      <div
        className={cn(
          ...
          orbState === "listening" && "bg-gradient-to-br from-[hsl(0,0%,85%)] to-[hsl(0,0%,55%)] shadow-[inset_0_-20px_60px_rgba(0,0,0,0.2),inset_0_20px_40px_rgba(255,255,255,0.3),0_0_120px_rgba(255,255,255,0.25)]",
          ...
          <div
            ...
            style={{
              background: {
                ...
                listening: "radial-gradient(circle, hsla(0,0%,95%,0.75) 0%, transparent 70%)",
          ...
          <div
            ...
            style={{
              background: {
                ...
                listening: "radial-gradient(circle, hsla(0,0%,80%,0.65) 0%, transparent 70%)",
          ...
          <div
            ...
            style={{
              background: {
                ...
                listening: "radial-gradient(circle, hsla(0,0%,90%,0.6) 0%, transparent 70%)",
